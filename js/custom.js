...
$(document).on('ready', function () {
    ...
    // attractions carousel init
    new Swiper('.attractions .swiper-container', {
        pagination: '.attractions .items-pagination',
        paginationClickable: '.attractions .items-pagination',
        loop: true,
        grabCursor: true,
